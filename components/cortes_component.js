 ...
 * Renderiza el showcase de cortes premium en #seccion-cortes.
 * Colores basados en la paleta de Del Corral Premium Beef:
 *   fondo: --corral-bg (crema cálido)
 *   texto: --corral-brown (café oscuro)
 * ================================================================
 */
...
function renderCortes() {
  ...
  const url = typeof DEL_CORRAL_URL !== 'undefined' ? DEL_CORRAL_URL : '#';
